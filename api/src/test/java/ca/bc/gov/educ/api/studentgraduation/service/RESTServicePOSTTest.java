...
public class RESTServicePOSTTest {
    ...
    @Before
    public void setUp(){
        Mockito.reset(studentGraduationApiWebClient, responseMock, requestHeadersMock, requestBodyMock, requestBodyUriMock);
        ThreadLocalStateUtil.clear();
        when(this.studentGraduationApiWebClient.post()).thenReturn(this.requestBodyUriMock);
    ...
    public void testPost_GivenProperData_Expect200Response(){
        ...
        byte[] response = this.restService.post(TEST_URL, TEST_BODY, byte[].class, studentGraduationApiWebClient);
    ...
    public void testPost_Given4xxErrorFromService_ExpectServiceError() {
        ...
        this.restService.post(TEST_URL, TEST_BODY, byte[].class, studentGraduationApiWebClient);
    }
