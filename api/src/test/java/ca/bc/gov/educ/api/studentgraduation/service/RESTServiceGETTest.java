...
import ca.bc.gov.educ.api.studentgraduation.exception.ServiceException;
...
public class RESTServiceGETTest {
    ...
    public WebClient studentGraduationApiWebClient;
    ...
    private static final ParameterizedTypeReference<List<GraduationProgramCode>> refType = new ParameterizedTypeReference<List<GraduationProgramCode>>() {
    };

    @Before
    public void setUp(){
        when(this.studentGraduationApiWebClient.get()).thenReturn(this.requestHeadersUriMock);
    ...
    public void testGet_GivenProperData_Expect200Response(){
        ...
        String response = this.restService.get(TEST_URL_200, String.class, studentGraduationApiWebClient);
    ...
    public void testGetTypeRef_GivenProperData_Expect200Response(){
        when(this.responseMock.bodyToMono(refType)).thenReturn(Mono.just(new ArrayList<GraduationProgramCode>()));
        List<GraduationProgramCode> response = this.restService.get(TEST_URL_200, refType, studentGraduationApiWebClient);
    ...
    public void testGetTypeRef_GivenNullWebClient_Expect200Response(){
        when(this.responseMock.bodyToMono(refType)).thenReturn(Mono.just(new ArrayList<GraduationProgramCode>()));
        List<GraduationProgramCode> response = this.restService.get(TEST_URL_200, refType, null);
        Assert.assertEquals(new ArrayList<String>(), response);
    }
    ...
    public void testGet_Given5xxErrorFromService_ExpectServiceError(){
        ...
        this.restService.get(TEST_URL_503, String.class, studentGraduationApiWebClient);
    }
    ...
    public void testGetTypeRef_Given5xxErrorFromService_ExpectServiceError(){
        ...
        this.restService.get(TEST_URL_503, refType, studentGraduationApiWebClient);
    }

    @Test(expected = ServiceException.class)
    public void testGet_Given4xxErrorFromService_ExpectServiceError(){
        when(this.responseMock.bodyToMono(ServiceException.class)).thenReturn(Mono.just(new ServiceException()));
        this.restService.get(TEST_URL_403, String.class, studentGraduationApiWebClient);
    }

    @Test(expected = ServiceException.class)
    public void testGetTypeRef_Given4xxErrorFromService_ExpectServiceError(){
        when(this.responseMock.bodyToMono(ServiceException.class)).thenReturn(Mono.just(new ServiceException()));
        this.restService.get(TEST_URL_403, refType, studentGraduationApiWebClient);
    }
    ...
    public void testGet_Given5xxErrorFromService_ExpectConnectionError(){
        ...
        restService.get(TEST_URL_503, String.class, studentGraduationApiWebClient);
    }
    ...
    public void testGetTypeRef_Given5xxErrorFromService_ExpectWebClientRequestError(){
        ...
        Throwable cause = new RuntimeException("Simulated cause");
        when(responseMock.bodyToMono(String.class)).thenReturn(Mono.error(new WebClientRequestException(cause, HttpMethod.GET, null, new HttpHeaders())));
        restService.get(TEST_URL_503, refType, studentGraduationApiWebClient);
    }
