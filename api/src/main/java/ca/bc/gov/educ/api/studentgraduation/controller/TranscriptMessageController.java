...
public class TranscriptMessageController {
	...
	private final TranscriptMessageService transcriptMessageService;
	ResponseHelper response;
	    
	@Autowired
	public TranscriptMessageController(TranscriptMessageService transcriptMessageService, ResponseHelper response) {
	...
	public ResponseEntity<List<TranscriptMessage>> getAllTranscriptMessageList() {
		log.debug("getAllTranscriptMessageList : ");
	...
	public ResponseEntity<TranscriptMessage> getSpecificTranscriptMessageCode(@PathVariable String pgmCode,
		...
		log.debug("getSpecificTranscriptMessageCode : ");
