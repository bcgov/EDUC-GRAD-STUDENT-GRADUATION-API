FROM artifacts.developer.gov.bc.ca/artifactory/docker-remote/maven:3-jdk-11 as build
...
FROM artifacts.developer.gov.bc.ca/artifactory/docker-remote/openjdk:11-jdk
